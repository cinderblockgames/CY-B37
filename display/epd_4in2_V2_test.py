...
try:
    ...
    font24 = ImageFont.truetype(os.path.join(picdir, 'Aurebesh.otf'), 24)
    font18 = ImageFont.truetype(os.path.join(picdir, 'Aurebesh.otf'), 18)
    font35 = ImageFont.truetype(os.path.join(picdir, 'Aurebesh.otf'), 35)
